...
export const PencilIcon = ({size}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox={handleSize(size).view} className={handleSize(size).wh}>
...
export const EditIcon = ({size}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" strokeWidth={1.5} stroke="currentColor" viewBox={handleSize(size).view} className={handleSize(size).wh}>
...
export const CancelIcon = ({size}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox={handleSize(size).view} fill="currentColor" className={handleSize(size).wh}>
